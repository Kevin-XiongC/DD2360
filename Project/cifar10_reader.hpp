...
void read_test(const std::string& folder, std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_cifar10_file(images, labels, folder + "/test_batch", limit, func);
}
...
void read_training(const std::string& folder, std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_cifar10_file(images, labels, folder + "/data_batch_1", limit, func);
    read_cifar10_file(images, labels, folder + "/data_batch_2", limit, func);
    read_cifar10_file(images, labels, folder + "/data_batch_3", limit, func);
    read_cifar10_file(images, labels, folder + "/data_batch_4", limit, func);
    read_cifar10_file(images, labels, folder + "/data_batch_5", limit, func);
}
...
void read_test(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_test(dir, limit, images, labels, func);
}
...
void read_training(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_training(dir, limit, images, labels, func);
}
...
void read_training_categorical(const std::string& folder, std::size_t limit, Images& images, Labels& labels) {
    read_cifar10_file_categorical(images, labels, folder + "/data_batch_1", limit, 0);
    read_cifar10_file_categorical(images, labels, folder + "/data_batch_2", limit, 10000);
    read_cifar10_file_categorical(images, labels, folder + "/data_batch_3", limit, 20000);
    read_cifar10_file_categorical(images, labels, folder + "/data_batch_4", limit, 30000);
    read_cifar10_file_categorical(images, labels, folder + "/data_batch_5", limit, 40000);
}
...
void read_test_categorical(const std::string& folder, std::size_t limit, Images& images, Labels& labels) {
    read_cifar10_file_categorical(images, labels, folder + "/test_batch", limit, 0);
}
...
void read_training_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_training_categorical(dir, limit, images, labels);
}
...
void read_test_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_test_categorical(dir, limit, images, labels);
}
